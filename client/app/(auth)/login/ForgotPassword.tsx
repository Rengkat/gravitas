...
export default function ForgotPassword({ onBack }: Props) {
  ...
  if (sent) {
    return (
      <div className="text-center [animation:fadeUp_0.4s_ease_both]">
        ...
        <h2 className="font-serif text-[28px] text-green-900 leading-tight mb-3">Check your inbox</h2>
        ...
        <div className="space-y-3 mb-6 text-left">
          {[
            ...
            <div key={i} className="flex items-start gap-3 p-3.5 rounded-xl bg-white border border-green-900/10 text-sm">
  ...
  return (
    <div className="[animation:fadeUp_0.4s_ease_both]">
      ...
      <div className="mb-5">
        <label className="block text-[11px] font-bold text-green-900/60 mb-1.5 tracking-widest uppercase">Email Address</label>
      ...
      <p className="text-xs text-center text-green-700/40">
        ...
        <button onClick={onBack} className="text-green-700 font-semibold underline underline-offset-2 ml-1 bg-transparent border-none cursor-pointer">
          Log in
        </button>
      </p>
    </div>
