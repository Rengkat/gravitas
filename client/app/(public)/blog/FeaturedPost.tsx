...
function AuthorAvatar({ initials }: { initials: string }) {
  const base = "w-8 h-8 rounded-full flex items-center justify-center text-xs font-extrabold shrink-0";
    ...
    <div className="px-[5%] mb-12">
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          {/* Left — visual */}
          <div className={`relative min-h-[280px] lg:min-h-[400px] bg-gradient-to-br ${post.gradientCls} flex flex-col justify-between p-8 lg:p-10 overflow-hidden`}>
            {/* Grid */}
            ...
            {/* Glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 rounded-full pointer-events-none opacity-30" style={{
            ...
            <div className="relative z-[1] mt-auto">
              <div className="font-serif text-[80px] text-white/8 leading-none select-none">300+</div>
            </div>
          </div>
          ...
          <div className="p-8 lg:p-10 flex flex-col justify-between">
            <div>
              <h2 className="font-serif text-green-900 leading-[1.15] tracking-tight mb-4 group-hover:text-green-700 transition-colors"
                style={{ fontSize: "clamp(22px, 2.5vw, 32px)" }}>
                {post.title}
              </h2>
              <p className="text-text-muted text-[15px] leading-[1.75] mb-6">
                {post.excerpt}
              </p>
            </div>
