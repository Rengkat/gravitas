...
export const POSTS: Post[] = [
  /* ── FEATURED ── */
  {
    ...
    excerpt:
      "A step-by-step strategy used by 12,000+ Gravitas students to break the 300 barrier — covering subject selection, time allocation, weak topic targeting, and the final 72 hours.",
  ...
  },
  {
    ...
    excerpt:
      "Forget reading your textbook 10 times. The top-scoring students use spaced repetition, active recall, and interleaving. Here's how to apply each one with Gravitas.",
  ...
  },
  {
    ...
    excerpt:
      "A case study on how a Lagos secondary school deployed Gravitas's School Portal, set up custom CBT tests, and used weekly parent reports to drive accountability.",
  ...
  },
  {
    ...
    excerpt:
      "Adaeze failed JAMB in 2022 and 2023. In 2024, she used Gravitas for 90 days and scored 312. This is her exact study plan, the mistakes she fixed, and the moment everything clicked.",
  ...
  },
  {
    ...
    excerpt:
      "Over 60% of Nigerian students study in areas with poor connectivity. Here's how to download question banks, use Gravitas offline, and still have a full study session on a budget.",
    author: AUTHORS.fatima,
    date: "Dec 10, 2024",
    readTime: "5 min read",
  ...
  },
  {
    ...
    excerpt:
      "Most students lose marks on the same three essay mistakes: poor structure, weak vocabulary transitions, and missing conclusion paragraphs. Gravitas's AI marking shows you exactly where.",
    author: AUTHORS.ngozi,
    date: "Nov 28, 2024",
    readTime: "7 min read",
  ...
  },
  {
    ...
    excerpt:
      "Parents who check Gravitas's weekly WhatsApp report spend less time asking \"have you read?\" and more time giving targeted encouragement. Here's how to use data to guide, not pressure.",
    author: AUTHORS.kolade,
    date: "Nov 20, 2024",
    readTime: "6 min read",
