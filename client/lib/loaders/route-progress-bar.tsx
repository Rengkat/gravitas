...
// components/ui/loaders/route-progress-bar.tsx
//
// Thin 3px progress bar fixed to the top of the viewport.
// Fires automatically on every Next.js App Router navigation.
//
// Add once in app/layout.tsx:
//   import RouteProgressBar from '@/components/ui/loaders/route-progress-bar'
//   <RouteProgressBar />
...
export default function RouteProgressBar() {
  ...
  useEffect(() => {
    ...
    // Eased ticks to ~85 %
    const ticks: [number, number][] = [[20, 30], [45, 100], [65, 200], [80, 320], [85, 420]]
