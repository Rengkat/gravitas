...
// // components/ui/loaders/splash-loader.tsx
// //
// // Fullscreen splash screen shown on initial app load or route-level Suspense.
// // Usage:
// //   import SplashLoader from '@/components/ui/loaders/splash-loader'
// //   <SplashLoader />
// //   <SplashLoader message="Preparing your dashboard…" />
// //   <SplashLoader context="exam" />
...
//   default:   ['Loading your session…', 'Fetching your data…', 'Almost ready…', 'Preparing your dashboard…'],
...
// export default function SplashLoader({ context = 'default', message }: SplashLoaderProps) {
...
//         style={{ width: 380, height: 380, background: 'radial-gradient(circle, rgba(245,200,66,0.07) 0%, transparent 70%)' }}
//       />
...
//               style={{ fontFamily: "'DM Serif Display', serif", fontSize: 42, color: '#f5c842' }}
//             >
//               G
//             </span>
//           </div>
...
//         {/* Wordmark + cycling message */}
//         <div className="flex flex-col items-center gap-1.5">
//           <span style={{ fontFamily: "'DM Serif Display', serif", fontSize: 32, color: '#fff', letterSpacing: '-0.5px' }}>
//             Gravitas
//           </span>
//           <div className="overflow-hidden" style={{ height: 18 }}>
//             <p
...
//                 animation: 'msg-cycle 0.4s ease both',
//                 whiteSpace: 'nowrap',
//               }}
//             >
//               {messages[msgIndex]}
...
//         style={{ opacity: mounted ? 1 : 0, transition: 'opacity 0.5s 0.3s ease' }}
//       >
//         {[
//           { size: 7,  bg: 'rgba(255,255,255,0.25)', delay: '0s' },
//           { size: 9,  bg: '#3aab6a',                delay: '0.18s' },
//           { size: 9,  bg: '#f5c842',                delay: '0.36s' },
//           { size: 7,  bg: 'rgba(255,255,255,0.25)', delay: '0.54s' },
//         ].map((d, i) => (
//           <div
//             key={i}
//             className="rounded-full"
//             style={{ width: d.size, height: d.size, background: d.bg, animation: `dot-bounce 1.4s ease-in-out infinite ${d.delay}` }}
//           />
//         ))}
//       </div>

//       {/* Bottom progress bar */}
//       <div className="absolute bottom-0 left-0 right-0 z-10" style={{ height: 3, background: 'rgba(255,255,255,0.07)' }}>
//         <div
//           style={{
//             height: '100%',
//             background: 'linear-gradient(90deg, #1a4a2e, #2e8b57, #3aab6a, #f5c842)',
//             borderRadius: '0 2px 2px 0',
//             animation: 'indeterminate 2.4s ease-in-out infinite',
//           }}
//         />
//       </div>

//       <style>{`
//         @keyframes glow-pulse   { 0%,100%{transform:translate(-50%,-50%) scale(1);opacity:1} 50%{transform:translate(-50%,-50%) scale(1.18);opacity:0.65} }
//         @keyframes orbit-spin   { to { transform: translate(-50%,-50%) rotate(360deg); } }
//         @keyframes orbit-dot    { 0%{transform:translate(-50%,-50%) rotate(0deg) translate(54px) rotate(0deg)} 100%{transform:translate(-50%,-50%) rotate(360deg) translate(54px) rotate(-360deg)} }
//         @keyframes logo-breathe { 0%,100%{box-shadow:0 0 0 0 rgba(58,171,106,0)} 50%{box-shadow:0 0 28px 4px rgba(58,171,106,0.18)} }
...
//         @keyframes msg-cycle    { from{opacity:0;transform:translateY(6px)} to{opacity:1;transform:translateY(0)} }
